    ...
    <div className="w-[1240px]">
      <div className="flex flex-col">
        ...
        <div className='w-[1240px] flex flex-col gap-4 rounded-b-lg rounded-tr-lg p-5 bg-[#7b549b] justify-center px-6'>
          <h3 className="text-lg text-gray-100 font-semibold">{EXAMPLES[tabName].title}</h3>
          <p className="text-lg text-[#dfb4ff]">{EXAMPLES[tabName].description}</p>
          <span className={`${tabName === 'components' || tabName === 'jsx' || tabName === 'props' ? 'text-lg' : "text-"} text-gray-200 whitespace-pre-wrap font-light`}>{EXAMPLES[tabName].code}</span>
        </div>
      </div>
    </div>
  );
